...
:cover: {static}/images/blog/release/0-2/cover.png
...
Transform Gizmo Upgrades :author_dim:`(DiogoMendonc-a)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. image:: {static}/images/blog/release/0-2/transform_gizmo.gif

World Inspector Overhaul :author_dim:`(diogomsmiranda)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. image:: {static}/images/blog/release/0-2/world_inspector.gif

Sub-scene importing in scene editor :author_dim:`(teres4)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. image:: {static}/images/blog/release/0-2/scene_editor.gif

On the Engine
-------------

Physics Improvements :author_dim:`(fallenatlas)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.. image:: {static}/images/blog/release/0-2/complex_physics_sample.gif

Modular Renderer :author_dim:`(RiscadoA, tomas7770)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
To overcome this, we've restructured the renderer, splitting it into `several components with their respective plugins <https://docs.cubos.riscadoa.com/group__render-plugins.html>`_. The most important ones
...
.. image:: {static}/images/blog/release/0-2/scraps_vs_zombies_new_renderer.png
...
Clearer Plugin Dependencies :author_dim:`(RiscadoA)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Plugins may depend on each other. One example is the `physics plugin <https://docs.cubos.riscadoa.com/group__physics-plugin.html>`_, which depends on the `collisions plugin <https://docs.cubos.riscadoa.com/group__collisions-plugin.html>`_.
...
Of course, this is not ideal, and thus, we've added a new `defaults plugin <https://docs.cubos.riscadoa.com/group__defaults-plugin.html>`_ to the engine that includes all the plugins that are necessary for a basic game to run.
...
If you're interested in learning more about this feature and ECS in general on our engine, check out our `ECS feature guide <https://docs.cubos.riscadoa.com/features-ecs.html>`_.

Introducing Inheritance in Reflection :author_dim:`(roby2014)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

**Cubos** has a powerful `reflection system <https://docs.cubos.riscadoa.com/group__core-reflection.html>`_ to examine and interact with a structures and types at runtime
...
Repeating Systems and Fixed-Step Updates :author_dim:`(joaomanita)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Moving Away from the Old Serialization :author_dim:`(Dacops)`
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

`Serialization <https://docs.cubos.riscadoa.com/group__core-data-ser.html>`_ is a crucial part of the game engine that allows for the saving of any Cubos game components as well as then loading them in.

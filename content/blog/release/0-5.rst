...
Point shadows are enabled by adding a `PointShadowCaster <https://docs.cubos.riscadoa.com/structcubos_1_1engine_1_1PointShadowCaster.html>`_
...
You can read the previous blog posts for more detailed information (`0.3 <https://cubos.riscadoa.com/03-is-here.html>`_, `0.4 <https://cubos.riscadoa.com/04-is-out.html>`_).
...
The engine was only able to able to detect collisons between boxes, now we can add a `VoxelCollisionShape <https://docs.cubos.riscadoa.com/classcubos_1_1engine_1_1VoxelCollisionShape.html>`_

...
.. image-grid::
    images/prototype_logo_1_horizontal.png First design - horizontal layout
    images/prototype_logo_1_vertical.png First design - vertical layout
...
.. image-grid::
    images/prototype_logo_2_horizontal.png Second design - horizontal layout
    images/prototype_logo_2_vertical.png Second design - vertical layout
...
.. image-grid::
    images/prototype_logo_3.png Logo brainstorming
...
.. image-grid::
    images/prototype_logo_4_horizontal.png Final design - horizontal layout
    images/prototype_logo_4_vertical.png Final design - vertical layout
...
.. image-grid::
    images/brand_guidelines_1.png
    images/brand_guidelines_2.png
    images/brand_guidelines_3.png
    images/brand_guidelines_4.png

New 0.3 Features
================

On this release, we focused on adding essential features we've been wanting to have for quite some time now.
Features-wise, this release was a bit smaller than the previous one, as we spent a lot of time working on non-code related stuff, such as rebranding the project.
